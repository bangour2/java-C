...
----------------------------
**
the efficiency is just a little higher because, we split our input and recombine the results. In order words, with more than 1 thread, the job overload is cut down.  
